...
train_features = feature_importance.iloc[:70,0]
additional_features = [
...
train_features = np.unique(np.append(train_features, additional_features))
...
if make_predictions:
    ...
    # Output results
    results.to_csv('../03_Results/ada_boost_prediction.csv', sep=',', index=False)